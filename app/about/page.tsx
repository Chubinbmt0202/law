            ...
            <div className="relative mt-20">
                ...
                <div className="bg-cover bg-center h-64" style={{ backgroundImage: "url('/images/nganh-luat-3.jpeg')" }}>
                    <div className="flex items-center md:text-center justify-center h-full bg-black bg-opacity-50">
                        <h1 className="text-white text-center text-4xl font-bold">Thành lập doannh nghiệp</h1>
                    </div>
                </div>
                <section className=' max-w-7xl mx-auto px-5 py-8 mt-8'>
                    ...
                    <p className=' py-6'>Công ty Luật và Kế toán Thiện Minh bắt đầu hoạt động từ năm 2016. Đến hiện tại với hơn 8+ năm phát triển, Thiện Minh dần khẳng định vị thế là một trong những công ty dẫn đầu trong lĩnh vực cung cấp dịch vụ tư vấn Pháp Lý Doanh Nghiệp tại Việt Nam. Thiện Minh hoạt động hướng đến mục tiêu bảo vệ quyền và lợi ích của khách hàng, cam kết mang đến dịch vụ chuyên nghiệp, đáng tin cậy cho các quý doanh nghiệp.
                        ...
                        Khi hợp tác với Thành lập doannh nghiệp, quý doanh nghiệp sẽ được tư vấn pháp lý và chiến lược kinh doanh, đảm bảo lợi ích cao nhất. Phương châm hoạt động của chúng tôi là “Phòng ngừa rủi ro, phát triển bền vững”. Luật và Kế toán Thiện Minh sẽ là địa chỉ hàng đầu cho các quý doanh nghiệp với mọi vấn đề về pháp lý.</p>
                    ...
                    <h3>Thành lập doannh nghiệp phấn đấu trở thành cộng sự đồng hành trên sự thành công của doanh nghiệp. Sự tin tưởng của khách hàng chính là nền tảng giúp chúng tôi phát triển trong tương lai. Sứ mệnh của chúng tôi là:</h3>
                    <ul className="list-disc pl-5 mt-2">
                    ...
                    <p>Bằng tất cả sự cống hiến và tận tâm trong nghề, Thành lập doannh nghiệp phấn đấu trở thành một trong những công ty luật hàng đầu tại Việt Nam cung cấp dịch vụ pháp lý, thành lập và phát triển doanh nghiệp, kế toán trọn gói.</p>
                    <p>Thành lập doannh nghiệp đặt mục tiêu thúc đẩy sự thay đổi tích cực trong việc quản lý, đầu tư và kinh doanh của doanh nghiệp, tối ưu quá trình kiểm soát và giảm thiểu rủi ro pháp lý. Chúng tôi hỗ trợ doanh nghiệp nâng cao hiệu suất sản xuất, kinh doanh và tăng cường năng lực cạnh tranh trên thị trường thông qua cung cấp các giải pháp tư vấn pháp lý, quản lý và đầu tư chuyên nghiệp.</p>
                    ...
                    <ul className="list-disc pl-5 mt-2">
                        ...
                        <li>Xây dựng lòng tin với khách hàng và gia tăng uy tín, chất lượng dịch vụ của Thành lập doannh nghiệp</li>
                    ...
                    <h2 className="text-2xl font-bold">3. Dịch vụ pháp lý tại Thành lập doannh nghiệp</h2>
                    <div className='mt-6'>
                        <Image
                            width={1920}
                            height={1920}
                    ...
                    <h3>Thành lập doannh nghiệp cung cấp gói dịch vụ thành lập Doanh lập với mức chi phí cực kỳ phải chăng chỉ từ 1.190.000vnđ đến 3.890.000vnđ đã bao gồm:</h3>
                    <ul className="list-disc pl-5 mt-2">
                        ...
                        <li>Đăng ký với cơ quan quản lý thuế (Thành lập doannh nghiệp sẽ hỗ trợ 500k khi khai báo với cơ quan thuế)</li>
                    ...
                    <p>Thành lập doannh nghiệp cung cấp cho Doanh nghiệp giải pháp kinh doanh đa chiều, sáng tạo và đem lại hiệu quả tối đa với các vấn đề mà Doanh nghiệp đang đối mặt. Chúng tôi không những chỉ dẫn về những cơ hội và rủi ro trong lĩnh vực đầu tư và kinh doanh mà còn tạo sự gắn kết giữa cơ hội và mục tiêu, chiến lược kinh doanh của từng doanh nghiệp.</p>
                    <p>Thành lập doannh nghiệp cung cấp dịch vụ pháp lý Doanh nghiệp về:</p>
                    <ul className="list-disc pl-5 mt-2">
                        ...
                        <li>Tư vấn các vướng mắc của doanh nghiệp tại văn phòng Thành lập doannh nghiệp hoặc trực tuyến bởi các chuyên gia pháp lý, luật sư giàu kinh nghiệm, uy tín</li>
                    </ul>

                    <h1 className='text-xl text-red-500'>Dịch vụ kế toán thuế</h1>
                    <p>Dịch vụ kế toán tại Thành lập doannh nghiệp sẽ giải quyết hết những công việc liên quan đến việc quyết toán, in và bàn giao sổ, báo cáo tài chính, lập sổ sách, báo cáo thuế,… một cách chính xác cho các doanh nghiệp. Với chi phí chỉ từ 500k/tháng, doanh nghiệp sẽ nhận được:</p>
                    <ul className="list-disc pl-5 mt-2">
                    ...
                    <h2 className="text-2xl font-bold">4. Lý do quý doanh nghiệp nên chọn dịch vụ của Thành lập doannh nghiệp</h2>
                    <ul className="list-disc pl-5 mt-2">
                        <li><strong>Chuyên nghiệp:</strong>Thành lập doannh nghiệp được khách hàng tin tưởng với dịch vụ pháp lý chất lượng cao. Với đội ngũ luật sư giàu kinh nghiệm và chuyên môn cao, chúng tô hỗ trợ và giải quyết các thủ tục pháp lý một cách nhanh chóng</li>
                        ...
                        <li><strong>Chi phí hợp lý:</strong>Là một trong những công ty luật hàng đầu với đội ngũ luật sư có chuyên môn cao, chúng tôi mang đến cho khách hàng dịch vụ pháp lý được thực thi với chuyên gia với mức phí hợp lý. Thành lập doannh nghiệp cam kết chi phí sẽ được cân đối và mang lại hiệu quả cao cho cả hai bên</li>
                        <li><strong>Đơn giản và tiện lợi:</strong>Bạn không muốn mất thời gian và công sức di chuyển? Chỉ cần ủy quyền toàn bộ công việc cho Thành lập doannh nghiệp và chúng tôi sẽ đại diện cho bạn trong việc thực hiện tất cả các thủ tục và hồ sơ từ A đến Z</li>
                        ...
                        <li><strong>Bảo mật tuyệt đối:</strong>Thành lập doannh nghiệp cam kết bảo mật tuyệt đối thông tin khách hàng về giấy tờ, bí mật đời tư liên quan đến vụ việc. Chỉ khi có sự đồng ý của khách hàng thì chúng tôi mới công khai thông tin trong công việc</li>
