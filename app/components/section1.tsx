        ...
        <div className=" w-full relative flex items-center justify-center">
            <div className="inset-0 bg-black bg-opacity-3 bg-cover w-full" style={{ backgroundImage: "url('/images/6.png')" }}>
                <div className="section2 text-center text-white z-10 py-10">
                    <h1 className="text-4xl font-bold text-blue-800">DỊCH VỤ TƯ VẤN ĐĂNG KÝ KINH DOANH</h1>
                    <h2 className="text-2xl font-bold text-red-500">TẠI TRUNG TÂM HỖ TRỢ DOANH NGHIỆP ĐÀ NẴNG</h2>
                    <h1 className="text-2xl font-bold text-stone-900">ĐẾN NĂM 2024</h1>
                    {/* Statistics Boxes */}
                    <div className="flex justify-center mt-8">
                        <div className="bg-white w-1/5 mx-8 border-8 border-yellow-500 p-6 shadow-lg">
                        ...
                        <div className="bg-white w-1/5 border-8 mx-8 border-yellow-500 p-6 rounded-lg shadow-lg">
