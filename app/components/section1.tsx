        ...
        <div className=" w-full relative flex items-center justify-center">
            <div className="inset-0 bg-black bg-opacity-3 bg-cover w-full" style={{ backgroundImage: "url('/images/6.png')" }}>
                <div className="section2 text-center text-white z-10 py-10">
                    ...
                    {/* Statistics Boxes */}
                    <div className="flex w-full justify-center md:flex-row items-center flex-col mt-8">
                        <div className="bg-white md:w-1/5 w-4/5 mt-5 mx-8 border-8 border-yellow-500 p-6 shadow-lg">
                        ...
                        <div className="bg-white md:w-1/5 w-4/5 mt-5 border-8 mx-8 border-yellow-500 p-6 rounded-lg shadow-lg">
