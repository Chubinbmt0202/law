...
const Section6 = () => {
    return (
        <div className="py-10 w-full h-full bg-black bg-cover" style={{ backgroundImage: "url('/images/9.png')" }}>
            <h1 className="text-3xl font-bold text-center">ĐĂNG KÝ THÀNH LẬP CÔNG TY TRỌN GÓI</h1>
            <h2 className="text-2xl font-bold text-center text-yellow-800 mb-6">TRUNG TÂM HỖ TRỢ DOANH NGHIỆP ĐÀ NẴNG</h2>
